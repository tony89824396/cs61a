...
def is_swap(score0, score1):
    ...
    if score0 !=1 and score1 !=1:
        if (score0/score1) ==  int(score0/score1) or (score1/score0) ==int(score1/score0):
            return True
        else:
            return False
    else:
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        increase=current-previous_score
        ...
        return announce_highest(who, max(previous_high,increase), current)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    a=make_averaged(roll_dice,20)
    #roll 20 times should cover all cases with high returns.
    i,times,c=1,1,0
    while i <11:
        b=a(i,dice)
        if b>c:
