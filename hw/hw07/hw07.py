...
class Fib():
    ...
    def next(self):
        ...
        if self.value==0:
            ...
            a.value=a.pre+self.pre
            #self.pre is current value
            #a.pre is previous one
        return a
...
class VendingMachine:
    ...
    def restock(self,value=0):
        self.value=self.value+value
        return 'Current {0} stock: {1}'.format(self.product,self.value)
    ...
    def vend(self):
        if self.value==0:
            ...
            return "You must deposit ${0} more.".format(a)
        elif self.balance > self.price:
            b=self.balance-self.price
            self.value=self.value-1
            self.balance=0
            return 'Here is your {0} and ${1} change.'.format(self.product,b)
        else:
            self.balance=0
            self.value=self.value-1
